...
def retrieve_context(user_query: str, top_k: int = None, top_k_rerank: int = None) -> Dict[str, Any]:
    ...
    raw_chunks = retrieve_chunks(query_text=query_en, top_k=top_k)
    
    # Step 3: Cross-encoder reranking
    _logger.info("Reranking chunks")
    chunks = rerank_chunks(query_en, raw_chunks, top_k_rerank=top_k_rerank)
